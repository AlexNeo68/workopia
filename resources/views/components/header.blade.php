<header class="bg-blue-900 text-white p-4">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <nav class="hidden md:flex items-center space-x-4">
            <a href="{{ route('jobs.index') }}" class="text-white hover:underline py-2">All Jobs</a>
    ...
    <nav id="mobile-menu" class="hidden md:hidden bg-blue-900 text-white mt-5 pb-4 space-y-2">
        <a href="{{ route('jobs.index') }}" class="block px-4 py-2 hover:bg-blue-700">All Jobs</a>
        <a href="{{ route('jobs.saved') }}" class="block px-4 py-2 hover:bg-blue-700">Saved Jobs</a>
        ...
        <a href="{{ route('jobs.create') }}" class="block px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-black">
            <i class="fa fa-edit"></i> Create Job
        </a>
    </nav>
</header>
