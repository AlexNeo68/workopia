    ...
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('jobs.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea cols="30" rows="7" @error('description') border-red-500 @enderror id="description"
                    name="description" class="w-full px-4 py-2 border rounded focus:outline-none"
            ...
            <div class="mb-4">
                ...
                <select id="job_type" name="job_type"
                    ...
                    <option value="Full-Time" @if (old('job_type') == 'Full-Time') selected @endif>
                        Full-Time
                    </option>
                    <option @if (old('job_type') == 'Part-Time') selected @endif value="Part-Time">Part-Time</option>
                    <option @if (old('job_type') == 'Contract') selected @endif value="Contract">Contract</option>
                    <option @if (old('job_type') == 'Temporary') selected @endif value="Temporary">Temporary</option>
                    <option @if (old('job_type') == 'Internship') selected @endif value="Internship">Internship</option>
                    <option @if (old('job_type') == 'Volunteer') selected @endif value="Volunteer">Volunteer</option>
                    <option @if (old('job_type') == 'On-Call') selected @endif value="On-Call">On-Call</option>
                </select>
                @error('job_type')
                    <div class="text-red-500 text-xs">{{ $message }}</div>
                @enderror
